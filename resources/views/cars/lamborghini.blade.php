...
<head>
  ...
  <title>LuxCar - Lamborghini Aventador</title>
</head>
    @vite([
...
<div class="egesz">
  <div class="kepauto">
    <div class="auto1">
      <img src="{{ asset('/images/Autok/Autok/Bentley Continental GT/GT1.jpg') }}" alt="porsche">
    </div>

    <div class="auto3">
      <img class="autocska"src="{{ asset('/images/Autok/Autok/Bentley Continental GT/GT2.jpg') }}" alt="porsche">
