...
<div class="egesz">
  <div class="kepauto">
    <div class="auto1">
      <img src="{{ asset('/images/Autok/Autok/Rolls Royce Phantom/phantom2.jpg') }}" alt="porsche">
    </div>

    <div class="auto3">
      <img class="autocska"src="{{ asset('/images/Autok/Autok/Rolls Royce Phantom/phantom1.jpg') }}" alt="porsche">
