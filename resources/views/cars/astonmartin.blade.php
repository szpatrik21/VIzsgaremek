...
<head>
  ...
  <title>LuxCar - Aston Martin DB11</title>
</head>
    @vite([
...
<div class="egesz">
  <div class="kepauto">
    <div class="auto1">
      <img src="{{ asset('/images/Autok/Autok/Aston Martin DB11/Aston1.jpg') }}" alt="porsche">
    </div>

    <div class="auto3">
      <img class="autocska"src="{{ asset('/images/Autok/Autok/Aston Martin DB11/Aston2.jpg') }}" alt="porsche">
  ...
  <div class="ar">
    <h3 class="ar1">Aston Martin DB11</h3>
    <div class="ar2">
      <p>52 000 000 Ft</p>
    </div>
  </div>
