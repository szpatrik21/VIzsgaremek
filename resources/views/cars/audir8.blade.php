...
<head>
  ...
  <title>LuxCar - Audi R8 V10 Performance</title>
</head>
    @vite([
...
<div class="egesz">
  <div class="kepauto">
    <div class="auto1">
      <img src="{{ asset('/images/Autok/Autok/Audi R8 V10 Performance/R82.jpg') }}" alt="Audi R8 V10 Performance">
    </div>

    <div class="auto3">
      <img class="autocska"src="{{ asset('/images/Autok/Autok/Audi R8 V10 Performance/R81.webp') }}" alt="Audi R8 V10 Performance">
  ...
  <div class="ar">
    <h3 class="ar1">Audi R8 V10 Performance</h3>
    <div class="ar2">
      <p>52 000 000 Ft</p>
    </div>
  </div>
