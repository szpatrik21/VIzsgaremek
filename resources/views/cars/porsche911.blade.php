...
<div class="egesz">
  <div class="kepauto">
    <div class="auto1">
      <img src="{{ asset('/images/Autok/Autok/Porsche 911 Turbo S/Porsche1.webp') }}" alt="porsche 911 Turbo S">
    </div>

    <div class="auto3">
      <img class="autocska"src="{{ asset('/images/Autok/Autok/Porsche 911 Turbo S/Porsche2.jpeg') }}" alt="Porsche 911 Turbo S">
  ...
  <div class="ar">
    <h3 class="ar1">Porsche 911 Turbo S</h3>
    <div class="ar2">
      <p>52 000 000 Ft</p>
    </div>
  </div>
