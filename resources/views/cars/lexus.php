...
<head>
  ...
  <title>LuxCar - Alfa Romeo Giulia Quadrifoglio</title>
</head>
    @vite([
...
<div class="egesz">
  <div class="kepauto">
    <div class="auto1">
      <img src="{{ asset('/images/Autok/Autok/Alfa Romeo Giulia Quadrifoglio/Alfa1.jpg') }}" alt="porsche">
    </div>

    <div class="auto3">
      <img class="autocska"src="{{ asset('/images/Autok/Autok/Alfa Romeo Giulia Quadrifoglio/Alfa2.jpg') }}" alt="porsche">
  ...
  <div class="ar">
    <h3 class="ar1">Alfa Romeo Giulia Quadrifoglio</h3>
    <div class="ar2">
      <p>52 000 000 Ft</p>
    </div>
  </div>
